  ...
  return (
    <section id='main'>
      <div className='main-content'>
        ...
        <span className='main-intro__text'>I'm <span className='main-intro__name'>Kris</span> <br />VFX Artist</span>
        ...
        <div className='main-button_box'>
          ...
          <Link>
            <button className='main-button' id='resume-button'>
              <img src={resumeImg} alt='play video' className='main-button__image' />
              Resume
            </button>
          </Link>
        </div>
